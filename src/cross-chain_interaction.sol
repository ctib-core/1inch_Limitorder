...
//     uint16 public constant  FILL_ORDER_TO_WITH_PERMIST = 6; 
//     uint16 public constant  FILL_ORDER_TO = 7 ;// fillOrderTo
//     uint16 public constant   CANCEL_ORDER  = 8 ; //cancelOrder
//     uint16 public constant   CHECKPREDICATE  = 9 ; //checkPredicate
...
//     function _executeFillOrder(OrderLib.Order memory request) internal returns(bool success, uint256 resultAmount, string memory errorMessage){
//         try this.fillOrder(request)
//         {
//            success = true;
